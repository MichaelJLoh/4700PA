    ...
    for k = 1:Reg.n
        ...
        if bc{k}.NumS > 0
            for q = 1:bc{k}.NumS 
                ...
                Einc = bc{k}.s(q).fct(yC{k},i,t,bc{k}.s(q).paras);
                Eincp = bc{k}.s(q).fct(yC{k},i,t-ds/c_c/2,bc{k}.s(q).paras);
                
                Hy{k}(bc{k}.s(q).xpos,:) = Hy{k}(bc{k}.s(q).xpos,:) + dt/ds/c_mu_0*Einc;
                Ez{k}(bc{k}.s(q).xpos-1,:) = Ez{k}(bc{k}.s(q).xpos-1,:) - dt/ds/c_eps_0/c_eta_0*Eincp;
